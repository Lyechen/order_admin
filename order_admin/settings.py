"""
Django settings for order_admin project.
...
SECRET_KEY = 'shoct!pf9r8qa2n1swd2m91wj+aopkt^hzxy=xz&++-=+3vy5e'
...
WSGI_APPLICATION = 'order_admin.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'root': {
            'class': LOG_CLASS,
            'formatter': 'verbose',
            'filename': os.path.join(LOGGING_DIR, '%s.log' % datetime.datetime.now().strftime('%Y-%m-%d')),
